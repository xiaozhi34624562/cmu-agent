...
class BaseTask:
    ...
    def generate(
        ...
        Args:
            ...
            instruction # ADDED
                Custom instruction for generation
            **kwargs:
        ...
        messages_dict = self.prepare_generation_inputs(results, prepare_messages, instruction)
        self.generate_results = model.generation(messages_dict, **kwargs)

        return self.generate_results

    def prepare_generation_inputs(
            self, results, prepare_messages, instruction
    ) -> Dict[str, List[dict]]:
        """
        ...
        for query_id, result in results.items():
            ...
            documents = [
                self.corpus[doc_id] for doc_id in result
            ] # Modified (Removing Score | Dict -> List)
            messages = prepare_messages(query, documents, instruction)
